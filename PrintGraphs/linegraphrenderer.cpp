...
QString LineGraphRenderer::formatDateTime(qreal timestamp) const
{
    QDateTime dateTime = QDateTime::fromMSecsSinceEpoch(static_cast<qint64>(timestamp));
    return dateTime.toString("dd.MM.yyyy HH:mm");
}

void LineGraphRenderer::render(const QList<QPointF>& data)
{
...
void LineGraphRenderer::setStyle(bool isColored)
{
...
bool LineGraphRenderer::isEmpty() const
{
